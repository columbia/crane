...
then
    ...
    then
        client_cmd="${msmr_root_client}/apps/apache/install/bin/ab -n 1 -c 1 http://128.59.17.174:9000/test.php"
    else
        client_cmd="${msmr_root_client}/apps/apache/install/bin/ab -n 1 -c 1 http://128.59.17.174:9000/test.php"
    fi
else
    client_cmd="${msmr_root_client}/apps/apache/install/bin/ab -n 1 -c 1 http://128.59.17.174:7000/test.php"
fi
